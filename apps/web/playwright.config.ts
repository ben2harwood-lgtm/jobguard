...
export default defineConfig({
  ...
  webServer: {
    ...
    command: `JOBGUARD_ENV=synthetic_demo JOBGUARD_E2E_SHUTDOWN_TOKEN=${shutdownToken} DATABASE_URL=${E2E_RUNTIME_URL} ${process.env.CI ? "pnpm exec next start --hostname 127.0.0.1 --port 3000" : "pnpm dev"}`,
