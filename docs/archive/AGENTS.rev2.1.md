...
**Companion:** `BUILD_PLAN.md`, revision 2.1  
...
|---|---|
| Language/runtime | TypeScript, `strict: true`; Node 22 on a supported security-patched release. Confirm support and package compatibility at implementation; schedule an upgrade before end of support. |
